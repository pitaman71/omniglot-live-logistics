...
__export(index_exports, {
  Address: () => Address_exports2,
  DateTime: () => DateTime_exports2,
  Municipality: () => Municipality_exports2,
  Where: () => Where_exports2
});
...
// ../models/src/index.ts
var import_omniglot_live_data19 = require("@pitaman71/omniglot-live-data");
...
var import_omniglot_live_data = require("@pitaman71/omniglot-live-data");
var directory = new import_omniglot_live_data.Definitions.Directory();
var makePath = (path) => `omniglot-live-logistics.Address.${path}`;
var Domain = new import_omniglot_live_data.Values.AggregateDomain(makePath("Domain"), {
  addressLine1: import_omniglot_live_data.Values.TheStringDomain,
  addressLine2: import_omniglot_live_data.Values.TheStringDomain,
  postalCode: import_omniglot_live_data.Values.TheStringDomain
...
// ../models/src/Date.ts
var import_omniglot_live_data2 = require("@pitaman71/omniglot-live-data");
var directory2 = new import_omniglot_live_data2.Definitions.Directory();
var makePath2 = (path) => `omniglot-live-logistics.Date.${path}`;
var _Domain = class extends import_omniglot_live_data2.Values.AggregateDomain {
  constructor(path) {
    super(path, {
      year: new import_omniglot_live_data2.Values.RangeDomain(makePath2("Domain.year"), 0, void 0, 1),
      month: new import_omniglot_live_data2.Values.RangeDomain(makePath2("Domain.month"), 1, 12, 1),
      day: new import_omniglot_live_data2.Values.RangeDomain(makePath2("Domain.day"), 1, 31, 0)
    }, ["year", "month", "day"]);
  }
  asString(format) {
    const domain = this;
...
var import_omniglot_live_data3 = require("@pitaman71/omniglot-live-data");
var directory3 = new import_omniglot_live_data3.Definitions.Directory();
var makePath3 = (path) => `omniglot-live-logistics.DateRange.${path}`;
var Domain3 = new class _Domain2 extends import_omniglot_live_data3.Values.AggregateDomain {
  constructor() {
...
var import_omniglot_live_data7 = require("@pitaman71/omniglot-live-data");

// ../models/src/Time.ts
var import_omniglot_live_data6 = require("@pitaman71/omniglot-live-data");

// ../models/src/Meridian.ts
var import_omniglot_live_data4 = require("@pitaman71/omniglot-live-data");
var directory4 = new import_omniglot_live_data4.Definitions.Directory();
var makePath4 = (path) => `omniglot-live-logistics.Meridian.${path}`;
var Domain4 = new import_omniglot_live_data4.Values.EnumerationDomain(makePath4("Domain"), "am", "pm");
...
// ../models/src/Zone.ts
var import_omniglot_live_data5 = require("@pitaman71/omniglot-live-data");
var Introspection = __toESM(require("typescript-introspection"));
var directory5 = new import_omniglot_live_data5.Definitions.Directory();
var makePath5 = (path) => `omniglot-live-logistics.Zone.${path}`;
var _Domain3 = class extends import_omniglot_live_data5.Values.AggregateDomain {
  constructor(path) {
    super(path, {
      name: import_omniglot_live_data5.Values.TheStringDomain,
      short: import_omniglot_live_data5.Values.TheStringDomain,
      long: import_omniglot_live_data5.Values.TheStringDomain,
      minutes: import_omniglot_live_data5.Values.TheNumberDomain
    });
  }
  asString(format) {
    const domain = this;
...
// ../models/src/Time.ts
var directory6 = new import_omniglot_live_data6.Definitions.Directory();
var makePath6 = (path) => `omniglot-live-logistics.Time.${path}`;
var _Domain4 = class extends import_omniglot_live_data6.Values.AggregateDomain {
  constructor(path) {
    super(path, {
      hour: new import_omniglot_live_data6.Values.RangeDomain(`${path}.hour`, 0, 23, 1),
      minute: new import_omniglot_live_data6.Values.RangeDomain(`${path}.minute`, 0, 59, 1),
      second: new import_omniglot_live_data6.Values.RangeDomain(`${path}.second`, 0, 59, 1),
      meridian: Domain4,
      zone: Domain5
    });
  }
...
// ../models/src/DateTime.ts
var directory7 = new import_omniglot_live_data7.Definitions.Directory();
var makePath7 = (path) => `omniglot-live-logistics.DateTime.${path}`;
var _Domain5 = class extends import_omniglot_live_data7.Values.AggregateDomain {
  constructor(path) {
    super(path, {
      date: Domain2,
      time: Domain6
...
var import_omniglot_live_data8 = require("@pitaman71/omniglot-live-data");
var Introspection2 = __toESM(require("typescript-introspection"));
var directory8 = new import_omniglot_live_data8.Definitions.Directory();
var makePath8 = (path) => `omniglot-live-logistics.Duration.${path}`;
var _Domain6 = class extends import_omniglot_live_data8.Values.AggregateDomain {
  constructor(path) {
    super(path, {
      days: import_omniglot_live_data8.Values.TheNumberDomain,
      hours: import_omniglot_live_data8.Values.TheNumberDomain,
      minutes: import_omniglot_live_data8.Values.TheNumberDomain,
      seconds: import_omniglot_live_data8.Values.TheNumberDomain
    });
  }
  asString(format) {
    return new class {
...
// ../models/src/Event.ts
var import_omniglot_live_data17 = require("@pitaman71/omniglot-live-data");

// ../models/src/When.ts
var import_omniglot_live_data10 = require("@pitaman71/omniglot-live-data");

// ../models/src/TimeRange.ts
var import_omniglot_live_data9 = require("@pitaman71/omniglot-live-data");
var directory9 = new import_omniglot_live_data9.Definitions.Directory();
var makePath9 = (path) => `omniglot-live-logistics.TimeRange.${path}`;
var Domain9 = new import_omniglot_live_data9.Values.AggregateDomain(makePath9("Domain"), {
  from: Domain6,
  to: Domain6
});
...
// ../models/src/When.ts
var directory10 = new import_omniglot_live_data10.Definitions.Directory();
var makePath10 = (path) => `omniglot-live-logistics.TimeRange.${path}`;
var _Domain7 = class extends import_omniglot_live_data10.Values.AggregateDomain {
  constructor(path) {
    super(path, {
      at: Domain2,
      dates: Domain3,
...
var import_omniglot_live_data15 = require("@pitaman71/omniglot-live-data");
...
var import_omniglot_live_data12 = require("@pitaman71/omniglot-live-data");

// ../models/src/Place.ts
var import_omniglot_live_data11 = require("@pitaman71/omniglot-live-data");
var directory11 = new import_omniglot_live_data11.Definitions.Directory();
var makePath11 = (path) => `omniglot-live-logistics.Place.${path}`;
var Domain11 = new import_omniglot_live_data11.Values.AggregateDomain(makePath11("Domain"), {
  shortName: import_omniglot_live_data11.Values.TheStringDomain,
  longName: import_omniglot_live_data11.Values.TheStringDomain,
  iso: new import_omniglot_live_data11.Values.AggregateDomain(makePath11("Domain.iso"), {
    standard: import_omniglot_live_data11.Values.TheStringDomain,
    code: import_omniglot_live_data11.Values.TheStringDomain
  })
}, ["shortName", "longName", "iso"]);
directory11.add(Domain11);

// ../models/src/Municipality.ts
var directory12 = new import_omniglot_live_data12.Definitions.Directory();
var makePath12 = (path) => `omniglot-live-logistics.Municipality.${path}`;
var Domain12 = new import_omniglot_live_data12.Values.AggregateDomain(makePath12("Domain"), {
  city: Domain11,
  county: Domain11,
  state: Domain11,
  country: Domain11
...
var import_omniglot_live_data14 = require("@pitaman71/omniglot-live-data");

// ../models/src/GeoPoint.ts
var import_omniglot_live_data13 = require("@pitaman71/omniglot-live-data");
var directory13 = new import_omniglot_live_data13.Definitions.Directory();
var makePath13 = (path) => `omniglot-live-logistics.GeoPoint.${path}`;
var Domain13 = new import_omniglot_live_data13.Values.AggregateDomain(makePath13("Domain"), {
  lat: import_omniglot_live_data13.Values.TheNumberDomain,
  lng: import_omniglot_live_data13.Values.TheNumberDomain
});
directory13.add(Domain13);

// ../models/src/GeoShape.ts
var directory14 = new import_omniglot_live_data14.Definitions.Directory();
var makePath14 = (path) => `omniglot-live-logistics.GeoShape.${path}`;
var Domain14 = new import_omniglot_live_data14.Values.UnionDomain(makePath14(`ShapeDomain`), "type", {
  Point: Domain13
});
directory14.add(Domain14);

// ../models/src/Where.ts
var directory15 = new import_omniglot_live_data15.Definitions.Directory();
var makePath15 = (path) => `omniglot-live-logistics.Where.${path}`;
var _Domain8 = class extends import_omniglot_live_data15.Values.AggregateDomain {
  constructor(canonicalName) {
    super(canonicalName, {
      name: import_omniglot_live_data15.Values.TheStringDomain,
      googlePlaceId: import_omniglot_live_data15.Values.TheStringDomain,
      address: Domain,
...
var Introspection3 = __toESM(require("typescript-introspection"));
var import_omniglot_live_data16 = require("@pitaman71/omniglot-live-data");
var directory16 = new import_omniglot_live_data16.Definitions.Directory();
...
// ../models/src/Event.ts
var directory17 = new import_omniglot_live_data17.Definitions.Directory();
var makePath17 = (path) => `omniglot-live-logistics.Event.${path}`;
var _Domain10 = class extends import_omniglot_live_data17.Values.AggregateDomain {
  constructor(canonicalName) {
    super(canonicalName, {
      where: Domain15,
      vicinity: Domain17,
...
var Introspection4 = __toESM(require("typescript-introspection"));
var import_omniglot_live_data18 = require("@pitaman71/omniglot-live-data");
var directory18 = new import_omniglot_live_data18.Definitions.Directory();
var makePath18 = (path) => `omniglot-live-logistics.Interval.${path}`;
var Domain19 = new class _Domain11 extends import_omniglot_live_data18.Values.AggregateDomain {
  constructor() {
...
// ../models/src/index.ts
var directory19 = import_omniglot_live_data19.Definitions.Directory.from(
  directory,
  directory2,
  directory3,
  directory7,
...
var Summary = ({
  ...
  if (!value?.addressLine1) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.default.Fragment, { children });
  }
  const asString = domain?.asString() || Address_exports.Domain.asString();
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "address-summary", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "icon", children: "\u{1F3E0}" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "content", children: asString.to(value) })
  ] });
};
var Document = ({
  domain,
...
var Summary2 = ({
  ...
  if (!value?.date && !value?.time) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react2.default.Fragment, { children });
  }
  const asString = domain?.asString() || DateTime_exports.Domain.asString();
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "datetime-preview", children: asString.to(value) });
};
var Document2 = ({
  value,
  client
...
var Summary3 = ({
  ...
  if (!value) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_react3.default.Fragment, { children });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "municipality-summary", onClick: () => client?.assign(value), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "content", children: asString.to(value) })
  ] });
};
var Document3 = ({
  value,
...
var Summary4 = ({
  ...
  if (!value?.name) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react4.default.Fragment, { children });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "where-detail", children: [
    ...
    (value?.geo || client) && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "geo-section", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "geo-content", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "geo-row", children: [
        ...
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "value", children: value?.geo?.type === "Point" && `${value?.geo.lat?.toFixed(6)}, ${value?.geo.lng?.toFixed(6)}` })
      ] }) })
    ] }),
